...
const HospitalNavbar = () => {
    ...
    return (
        <>
            {/* Navbar */}
            <nav className="bg-gradient-to-r from-blue-400 via-indigo-500 to-blue-600 shadow-lg w-screen fixed top-0 ">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex justify-between items-center py-4">
                        ...
                        <div className="hidden md:flex space-x-8">
                            {["Home", "Patient", "Doctor", "Ambulance"].map((item) => (
                                <a
            ...
            {/* Mobile Menu */}
            <div
                className={`md:hidden fixed inset-0 bg-gradient-to-r from-blue-400 via-indigo-500 to-purple-600 transition-transform duration-500 ${menuOpen ? "transform translate-x-0" : "transform translate-x-full"
                    } z-50`}
            >
