    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-400 to-purple-500">
      ...
      >
        <div className="rounded-2xl shadow-xl bg-white">
          <div className="p-8">
            <h2 className="text-3xl font-semibold text-center text-gray-900 mb-6">Welcome to HealthLink</h2>
            <form>
              <div className="mb-6">
            ...
            <p className="text-center text-sm text-gray-600 mt-4">
              Already have an account? <a onClick={()=>{navigate('/Login')}} href="#" className="text-indigo-500 hover:underline">Login</a>
            </p>
          </div>
        </div>
      </motion.div>
